...
public class TestTelephone {
    public static void main(String[] args) {
        ...
        Telephone telephone2 = new Telephone("Bas de gamme", processeur1,
                stockage1, ecran1);
        telephone2.addRam(ram1);
        telephone2.addRam(ram1);
        // Moyen de gamme
        Telephone telephone3 = new Telephone("Moyen de gamme", processeur1,
                stockage2, ecran2);
        telephone3.addRam(ram1);
        telephone3.addRam(ram1);
        // Haut de gamme
        Telephone telephone4 = new Telephone("Haut de gamme", processeur2,
                stockage3, ecran3);
